    ...
    private void ReportesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReportesMouseClicked
        // TODO add your handling code here:
         if (fechaDesde == null || fechaHasta == null) {
            javax.swing.JOptionPane.showMessageDialog(
                    this,
                    "Primero aplica un rango de fechas."
            );
            return;
        }
        ...
        try {
            ...
            servicioDAO.topServiciosMasRealizados(fechaDesde, fechaHasta, 5)
                    .forEach((nombre, cant)
                            -> items.add(new ItemReporteDTO("Servicio", nombre, cant)));

            repuestoDAO.topRepuestosMasUtilizados(fechaDesde, fechaHasta, 5)
                    .forEach((nombre, cant)
                            -> items.add(new ItemReporteDTO("Repuesto", nombre, cant)));

            java.util.Map<String, Integer> empleadosMasServicios
                    = ordenDAO.topEmpleadosPorOrdenesCompletadas(
                            fechaDesde,
                            fechaHasta,
                            5
                    );
            ...
            for (java.util.Map.Entry<String, Integer> empleado
                    : empleadosMasServicios.entrySet()) {
            ...
            org.jfree.chart.JFreeChart chart
                    = org.jfree.chart.ChartFactory.createBarChart(
                            "Empleados con más servicios completados",
                            "Empleado",
                            "Servicios",
                            dataset
                    );
            ...
            java.awt.image.BufferedImage bufferedImage
                    = chart.createBufferedImage(450, 250);
