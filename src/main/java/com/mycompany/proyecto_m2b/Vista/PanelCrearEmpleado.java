 ...
 * @author usuario
 */
public class PanelCrearEmpleado extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PanelCrearEmpleado.class.getName());
...
public void cargarTablaEmpleados(){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new PanelCrearEmpleado().setVisible(true));
    }
